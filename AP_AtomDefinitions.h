...
/*                                                                  *
	...
	parsing and setting meta-data into MPEG-4 files, in particular,
	iTunes-style meta-data.
	...
	Notes:
	- AtomicParsley sources use tabs with a Tab Stop of 2 !!!
	- This file follows the AtomicParsley source style,
	  but with a Tab Stop of 4 to be consistent with Untrunc style.
 *                                                                  */
//==================================================================//
/*                                                                  *
	MP4RA - MP4-family Registration Authority
	Official Registration Authority for ISOBMFF family of standards.
	Website: https://mp4ra.org/
...
#ifndef AP_ATOMDEFINITIONS_H_
#define AP_ATOMDEFINITIONS_H_
